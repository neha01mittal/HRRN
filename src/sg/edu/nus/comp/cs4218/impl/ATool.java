...
public abstract class ATool {
	...
	// mark this change-> all tools should now work assuming that the default
	// status code is set to 1
	...
	/**
	 * Executes the tool with args provided in the constructor TODO Use
	 * interface methods when implementing execute!
	 * 
	 * @param stdin
	 ...
	 * 
	 * @param statusCode
	 *            0 if executed normally. Otherwise, see
