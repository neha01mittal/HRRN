...
public class CopyToolTest {
	...
	// copyTool = new CopyTool(null);
	// String a[] = { testDirectoryListAbsoluteString.get(0),
	// testDirectoryListAbsoluteString.get(0) + "F:" };
	// copyTool = new CopyTool(a);
	// copyTool.execute(rootDirectory.toFile(), "");
	// assert (copyTool.getStatusCode() == 1);
	// }
	...
	// String arg[] = { testDirectoryListAbsoluteString.get(0) + File.separator
	// + "test.txt", testDirectoryListAbsoluteString.get(0) + File.separator +
	// "test2.txt",
	...
	// }
	//
	// // Test copying multiple files into existing file - the last copy
	// operation
	...
	// create(testDirectoryListAbsoluteString.get(1) + File.separator + "a.txt",
	// "something33");
	// String arg[] = { testDirectoryListAbsoluteString.get(0) + File.separator
	// + "test.txt", testDirectoryListAbsoluteString.get(0) + File.separator +
	// "test2.txt",
	...
	// copyTool = new CopyTool(arg);
	// copyTool.execute(rootDirectory.toFile(), "");
	// File f = new File(testDirectoryListAbsoluteString.get(1) + File.separator
	// + "a.txt");
	// assert (compare(f2, f));
	// f1.delete();
	// f2.delete();
	...
	// "test2.txt", "something2");
	// File f = new File(testDirectoryListAbsoluteString.get(2) + File.separator
	// + "a.txt");
	// create(testDirectoryListAbsoluteString.get(2) + File.separator + "a.txt",
	// "something33");
	...
	// }
	//
	// // Test copying multiple files into a folder where one file does not
	// exist
	// @Test
	...
	// String arg[] = { testDirectoryListAbsoluteString.get(0) + File.separator
	// + "test.txt", testDirectoryListAbsoluteString.get(1) + File.separator +
	// "test.txt",
	...
	// File.separator + " .." + File.separator + "newfolder" + File.separator +
	// "test1.txt");
	//
	// assert (compare(f1, f2));
	// f1.delete();
