...
public class MyFunctionsMoveToolTest {
	...
	public void testMoveFileWithRelativePath() {
		...
		File f1 = new File(testDirectoryListRelativeString.get(0)
				+ File.separator + "test.txt");
		create(testDirectoryListRelativeString.get(0) + File.separator
				+ "test.txt", "something");
		File f2 = new File(testDirectoryListRelativeString.get(0)
				+ File.separator + "test2.txt");
		moveTool.recursivemove(f1, f2);
		assertFalse(f1.exists());
	...
	public void testMoveToExistingFolder() {
		...
		f1 = new File(testDirectoryListAbsoluteString.get(0) + File.separator
				+ "level0level1" + File.separator + "test1.txt");
		f1.delete();
		f1 = new File(testDirectoryListAbsoluteString.get(0) + File.separator
				+ "level0level1");
		f1.delete();
	...
	public void testMoveFolderIntoFile() {
		...
		f1.delete();
		assertTrue(moveTool.getStatusCode() == 1);
	}
