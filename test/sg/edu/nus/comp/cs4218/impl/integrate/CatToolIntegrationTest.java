...
public class CatToolIntegrationTest {
	...
	public static void init() {
		...
		try {
			...
			create(file3.getAbsolutePath(), "This is file 3 content");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void testMove() throws IOException {
		String commandline = "move " + file1.getName() + " " + f1 + "| cat";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		// System.out.println(output);
		String expectedOutput = "";
	...
	public void testMove2() {
		String commandline = "move " + file1.getName() + "| cat test1.txt";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "This is test content and more\n";
		assertEquals(expectedOutput, output);
	...
	public void testWc() throws IOException {
		// breaking
		String commandline = "wc -l test3.txt | cat -";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		System.out.println(">>>>>>>>>>>" + commandline);
		String output = pipingTool.execute(f1, null);
		System.out.println(">>>>>>>>>>>" + "\n\n\n\n\n\n");
