...
public class LsToolIntegrationTest {
	...
	public void testPwd2() {
		String commandline = "pwd rubbishvalue | ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	@Test
	public void testCd2() {
		String commandline = "cd nextlevel | ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testMove() {
		String commandline = "move " + file1 + " " + f1 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
		file1.mkdir();
	}
	...
	public void testCopy2() {
		String commandline = "copy test1.txt testFolder2 | ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testDelete() {
		String commandline = "delete " + file1 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testEcho() {
		String commandline = "echo This is test| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	@Test
	public void testCat() {
		String commandline = "cat " + file1 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	@Test
	public void testWc2() {
		String commandline = "wc -x test1.txt | ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testPaste() {
		String commandline = "paste " + file1 + " " + file2 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testPaste2() {
		String commandline = "paste " + file1 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
	...
	public void testSort() {
		String commandline = "sort -c " + file1 + "| ls";
		PipingTool pipingTool = new PipingTool(commandline.split("\\|"));
		String output = pipingTool.execute(f1, null);
		String expectedOutput = "test1.txt\ntest2.txt\ntestFolder2";
		assertEquals(expectedOutput, output);
